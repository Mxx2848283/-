...
<BODY>
	...
	<TABLE id=Table4 cellSpacing=0 cellPadding=0 width=760 align=center
		border=0>
		<TBODY>
			<TR>
						...
						<TBODY>
							...
							<TR>
								...
								<TD vAlign=top bgColor=#ffffff height=500>
									<TABLE id=Table7 cellSpacing=0 cellPadding=0 width=704
										align=center border=0>
										<TBODY>
											<%--              <TR>--%>
											<%--                <TD>--%>
											...
											<TR>
												<TD class=box_border height=400><IFRAME
														src="${ctx}/user_info/reg_info.htm" frameBorder=0
														width="98%" height=400>请确保您的浏览器支持框架</IFRAME></TD>
											</TR>
											<TR>
												<TD height=50>
													<TABLE id=Table8 cellSpacing=0 cellPadding=0 width="50%"
														...
														<TBODY>
															<TR>
																<TD><A href="${ctx}/user_info/toRegister.do">
																		<DIV align=center>
																			<IMG id=IMG1 height=26
																				src="${ctx}/images/register/reg_agree.jpg" width=127
																				border=0><FONT face=宋体></FONT>
																		</DIV>
																</A></TD>
																<TD>
																	<DIV align=center>
																		<A href="javascript:window.close()"><IMG height=26
																			src="${ctx}/images/register/reg_disagree.jpg"
																			width=127 border=0></A>
																	</DIV>
																</TD>
															</TR>
														</TBODY>
