...
<TABLE cellSpacing=0 cellPadding=0 width=566 align=center border=0>
	<TBODY>
		<TR>
			<TD class=left2
				background="${ctx}/images/page/article/right5_1_4.jpg" height=30>
				选购文章</TD>
		</TR>
		<TR>
			<TD class="left , main"
				background="${ctx }/images/page/article/right5_2.jpg" height=255>
				<P align=center>
				<TABLE id=Table1 cellSpacing=0 cellPadding=0 width="97%" border=0>
					<TBODY>
						<TR>
							<TD align=left width=75%><SPAN id=TitleLabel
								style="FONT-WEIGHT: bold; FONT-SIZE: small">
									${article.title} </SPAN></TD>
							<td align=left><c:if test="${not empty role}">
