...
<TABLE cellSpacing=0 cellPadding=0 width="760" align=center border=0>
	<TBODY>
		<TR>
			<TD width=200 height=82><IMG height=38
				src="${ctx}/images/page/logo.jpg" width=180></TD>
			<TD width=560>
				<DIV align=center>
...
<TABLE cellSpacing=0 cellPadding=0 width=760 align=center border=0>
	<TBODY>
		<TR>
			<TD width=161 rowSpan=3><IMG height=54
				src="${ctx}/images/page/top1_1.jpg" width=161></TD>
			<TD width=552><IMG height=15 src="${ctx}/images/page/top2_1.jpg"
				width=552></TD>
			<TD width=47 rowSpan=3><IMG height=54
				src="${ctx}/images/page/top3_1.jpg" width=47></TD>
		</TR>
		<TR>
			<TD height=31>
				<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
					<TBODY>
						<TR>
							<TD width="22%"><A id=Head1_HyperLink1 href="index.do"><IMG
									style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"
									alt=市场首页 src="${ctx}/images/page/top2_2_1.jpg"></A></TD>
							<TD width="7%">&nbsp;</TD>
							<TD width="18%"><IMG onmouseover=ShowMenu(list,90) height=31
								src="${ctx}/images/page/top2_2_2.jpg" width=91 border=0></TD>
							<TD width="9%">&nbsp;</TD>
							<TD width="17%"><A id=Head1_HyperLink2 href="topost.do"><IMG
									style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"
									alt=发布信息 src="${ctx}/images/page/top2_2_3.jpg"></A></TD>
							<TD width="9%">&nbsp;</TD>
							<TD width="18%"><A id=Head1_HyperLink3 href="guidelist.do"><IMG
									style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"
